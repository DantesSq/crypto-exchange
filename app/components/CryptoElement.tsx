...
const CryptoElement: FC<CryptoElementProps> = ({
    ...
    return (
        ...
        // <tr className="h-[40px] my-[15px] text-text dark:text-gray">
        ...
        //     </h1>
        // </td>
        //     <td className=" ">{currencyFormat(Number(priceUsd))}</td>
        // <td className={`  ${profitColor}`}>
        //     {symbolProfit}
        //     {Number(changePercent24Hr).toFixed(2)} %
        // </td>
        //     <td className=" ">{currencyFormat(Number(marketCapUsd))}</td>
        //     <td className=" ">{currencyFormat(Number(volumeUsd24Hr))}</td>
        // </tr>
    );
};
