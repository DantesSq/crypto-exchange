...
const Watchlist = () => {
    ...
    if (data && data.data.length)
        return (
            <div className="lg:container my-[40px] px-[10px] md:px-[20px] lg:px-[60px] dark:bg-primaryD">
                <div className="p-[10px] md:p-[25px] my-[20px] bg-white dark:bg-secondD rounded-xl w-[100%] text-text">
